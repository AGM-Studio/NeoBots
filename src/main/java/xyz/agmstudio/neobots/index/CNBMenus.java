...
public final class CNBMenus {
    ...
    public static final MenuEntry<NeoBotMenu> NEOBOT_INVENTORY =
            REGISTRATE.menu("neobot_menu", NeoBotMenu::new, () -> AbstractMenu.Screen<NeoBotMenu>::new).register();

    public static final MenuEntry<TransferModuleMenu> TRANSFER_MODULE =
            REGISTRATE.menu("transfer_menu", TransferModuleMenu::new, () -> AbstractMenu.Screen<TransferModuleMenu>::new).register();
}